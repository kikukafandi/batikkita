...
<body class="bg-krem font-sans text-sogan">
    ...
    {{-- Header / Navigasi --}}
    <header class="bg-sogan text-krem shadow-md sticky top-0 z-50 bg-white">
        <nav class="container mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
            <a href="{{ url('/') }}"
                class="text-xl sm:text-2xl font-serif font-bold hover:text-emas transition">Batik Kita</a>

            {{-- Menu untuk Desktop --}}
            <div class="hidden md:flex items-center space-x-6">
                <a href="{{ url('/') }}" class="hover:text-emas transition">Home</a>
                <a href="{{ url('/products') }}" class="hover:text-emas transition">Produk</a>
                <a href="{{ url('/cart') }}" class="hover:text-emas transition">Keranjang</a>
                <a href="{{ url('/seller/dashboard') }}" class="hover:text-emas transition">Seller</a>
                <a href="{{ url('/admin/dashboard') }}" class="hover:text-emas transition">Admin</a>
            </div>

            {{-- Ikon Hamburger untuk Mobile (disembunyikan di desktop) --}}
            <div class="md:hidden">
        ...
        {{-- Tambahkan ID dan kelas 'hidden' dari Tailwind sebagai state awal --}}
        <div id="mobile-menu" class="hidden md:hidden bg-sogan/90 backdrop-blur-sm absolute w-full shadow-lg">
            <a href="{{ url('/') }}" class="block px-4 py-3 text-krem hover:bg-sogan">Home</a>
            <a href="{{ url('/products') }}" class="block px-4 py-3 text-krem hover:bg-sogan">Produk</a>
            <a href="{{ url('/cart') }}" class="block px-4 py-3 text-krem hover:bg-sogan">Keranjang</a>
        </div>
    </header>
    ...
    {{-- Footer --}}
    <footer class="bg-sogan text-krem mt-12 py-6">
        <div class="container mx-auto px-4 sm:px-6 text-center">
            <p>&copy; {{ date('Y') }} Batik Kita. All Rights Reserved.</p>
        </div>
    </footer>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Dijalankan oleh halaman lain di bawah
            // === LOGIKA UNTUK GALERI GAMBAR PRODUK ===
            ...
            if (mainImage && thumbnails.length > 0) {
                thumbnails.forEach(thumb => {
                    thumb.addEventListener('click', function() {
                        ...
                        thumbnails.forEach(t => t.classList.remove('border-emas'));

                        // Tambahkan border aktif ke thumbnail yang diklik
                        this.classList.add('border-emas');
                    });
                });
            }
        });
