    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="lg:w-3/4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition">
                    <div
                        class="h-48 bg-gradient-to-br from-batik-brown to-batik-maroon flex items-center justify-center">
                        <span class="text-white text-4xl">🌸</span>
                    </div>
                    <div class="p-4">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition">
                    <div
                        class="h-48 bg-gradient-to-br from-batik-gold to-batik-brown flex items-center justify-center">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition">
                    <div
                        class="h-48 bg-gradient-to-br from-purple-700 to-batik-maroon flex items-center justify-center">
                        <span class="text-white text-4xl">🦚</span>
                    </div>
                    <div class="p-4">
            ...
            <div class="mt-8 flex justify-center">
                <div class="flex space-x-2">
                    <button
                        class="px-3 py-2 bg-gray-300 text-gray-600 rounded hover:bg-gray-400 transition">Prev</button>
                    ...
                    <button
                        class="px-3 py-2 bg-gray-300 text-gray-600 rounded hover:bg-gray-400 transition">Next</button>
                </div>
            </div>
        </div>
    </div>
